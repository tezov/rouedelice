...
import com.tezov.lib_adr_sdk_core.navigation.NavigationRouteManager.Finish
...
class DialogCloseAppConfirmationAction private constructor(
    private val action: com.tezov.lib_adr_sdk_core.ui.composition.activity.sub.dialog.DialogAction,
    ...
    companion object {
        @Composable
        fun create(
            action: com.tezov.lib_adr_sdk_core.ui.composition.activity.sub.dialog.DialogAction,
